...
public class Message implements Serializable {
    ...
    // 这俩属性存在的目的，主要是为了让内存中的 Message 对象，能够快速找到对应的硬盘上的 Message 的位置
    ...
    // 创建一个工厂方法，让工厂方法帮我们封装一些创建 Message对象的过程
    // 这个方法中创建的 Message 对象，会自动生成唯一的 MessageId
    // 万一 routingKey 和 basicProperties 里的 routingKey冲突，以外面的为主
    public static Message createMessageWithId(String routingKey,BasicProperties basicProperties,byte[] body) {
        ...
        message.body=body;
        // 此处是把 body和 basicProperties 先设置出来，他俩是 Message的核心内容
